...
def lstm_joint_network(user_training_samples, product_training_samples, neighbourhood_training_samples, training_ground_truth, max_review_length, normalize_reviews, hidden_size):
        ...
        #--------------------------------------------------------------------------------------------------------------------> Classify
        dense_prepare1 = keras.layers.Dense(2049, activation='relu', name='prepare1')(overall_attention_output)
        print('Dense prepare ------>',dense_prepare1.shape)
        
        
        
        #--------------------------------------------------------------------------------------------------------------------> Classify
        dense_prepare2 = keras.layers.Dense(1024, activation='relu', name='prepare2')(dense_prepare1)
        print('Dense prepare ------>',dense_prepare2.shape)
        
        
        
        
        
        dense_output = keras.layers.Dense(max_review_length, activation='relu',name='classifyyyy')(dense_prepare2)
