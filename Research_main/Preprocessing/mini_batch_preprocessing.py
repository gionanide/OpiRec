...
def make_sorted_dataset():
        ...
        #path = '/media/data/gionanide/OpinionRecommendation/data/Feeding_samples_90-10_huge_reviews_40/' # -----------------> 53565 samples
        ...
        normalize_user_reviews = None
        normalize_product_reviews = None
        normalize_neighbourhood_reviews = 60  
        targets_overall = []
        ...
        for index, sample in enumerate(samples):
                ...
                if ( (normalize_user_reviews<39) or (normalize_product_reviews<99) or (normalize_neighbourhood_reviews<50) ):
        ...
        minibatch_training_file = open("REAL_minibatch_training.pkl","wb")
        ...
        minibatch_testing_file = open("REAL_minibatch_testing.pkl","wb")
        ...
        minibatch_development_file = open("REAL_minibatch_development.pkl","wb")
        pickle.dump(minibatch_development, minibatch_development_file)
        minibatch_development_file.close()
        tokenizer_file = open("REAL_tokenizer.pkl","wb")
