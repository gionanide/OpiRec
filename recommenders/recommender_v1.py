...
def lstm_joint_network(user_training_samples, product_training_samples, neighbourhood_training_samples, training_ground_truth, max_review_length, normalize_reviews, hidden_size):
        ...
        #product_attention_output = keras.layers.Reshape((1, 300))(product_attention_output)
        #print('User attention reshaped ------>',product_attention_output.shape)
        ...
        merged_hidden_sequence_all = keras.layers.Concatenate(axis=-1,name='concat1')([user_attention_output, product_attention_output, neighbourhood_attention_output])
        print('\n')
        ...
        #--------------------------------------------------------------------------------------------------------------------> Classify
        dense_prepare = keras.layers.Dense(1024, activation='relu', name='prepare')(merged_hidden_sequence_all)
